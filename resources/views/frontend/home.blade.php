...
<main id="content">
    ...
    <div class="action-bar text-center">
      <a href="find-helpers.html">Find & Hire now <span class="font-icon"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path fill="currentColor" d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg></span></a>
    </div>
          ...
          <div itemscope itemtype="https://schema.org/FAQPage">
            <amp-accordion expand-single-section animate disable-session-states>
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">The answer is technology and a whole lot of groundwork. <br><br>
    
    Helpers Near Me (HNM) makes it possible to find & hire 100+ profiles of workers near you online. <br><br>
    
    And it is easy as well. It is as easy as taking a cab through apps. <br><br>
    
    The platform uses complex algorithms to help you directly connect with multiple local workers without any middlemen & commissions. <br><br>
    
    You can easily connect with a few workers near you and hire anyone you like.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">The process is pretty simple. <br><br>
    
    First, you sign in with your credentials.<br><br>
    
    Second, you search for the profile of workers around your location. The platform automatically fetches and assigns a couple of best-rated workers to your search result. <br><br>
    
    Third, you select a plan, pay a nominal fee and connect with every worker who shows up in your search results. Among them, you hire whoever you like permanently. <br><br>
    
    In the end, once you've hired, you pay the salary directly to the worker.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">You can find & hire different profiles of Workers through Helpers Near Me. And you can hire the workers permanently. <br><br>
    
    You can find & hire workers like: <br>
    Domestic Workers; Drivers; School Workers; Restaurant Workers; Salon Workers; Office Workers; Factory Workers; Store Workers; Hospital Workers; Construction Workers; Automotive Workers; And many more.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">HNM verifies every worker legally. This process is more reliable than hiring a worker via reference or any other means.<br><br>
    
    The platform follows a 2/3 Step Background Verification Process:<br><br>
    
    1) ID Check, which checks the validity of the Govt. ID the individual carries <br><br>
    2) Court/Criminal Records Check, which scans the court records of the individual at the neighbouring Indian District Courts around their address, & <br><br>
    3) Address Check, which reports whether the person stays where one claims to be staying.<br><br>
    
    The first two are always pre-checked, while the 3rd one is available on request.<br><br>
    
    If you wish, you can access the worker's background verification report by paying a nominal fee.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">HNM is a paid service. The platform automatically assigns a convenience fee to your order. The fee usually starts at ₹99 but varies depending on the profile of workers you are searching for.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Once you pay, your order remains valid for the next 15 days. <br><br>
    
    It usually takes about 5-7 days to find a worker as per your requirement, but HNM still keeps your order active for 15 days from the date you place it. <br><br>
    
    In all likelihood, you should be able to find a relevant worker within these 15 days.<br><br>
    
    If you encounter any challenges, please contact customer care at HNM. The team at HNM will resolve your concerns within 24 hours.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">It is a one-time fee. It is not a subscription fee. <br><br>
    
    With this one-time fee, you can connect with a selected profile of local workers for a certain period of time until your order expires.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">No, you don't pay separately to connect with each worker. <br><br>
    
    And no, you do not get access to every worker on the platform. <br><br>
    
    We intend to solve your problem of finding & hiring a worker. To do this, HNM automatically assigns a few workers from around your search location, provided they are available. The fee is valid only for the number of workers the platform assigns to your search result. <br><br>
    
    You should be able to find a worker among the assigned ones. If you face any challenges, please contact HNM's customer care. The team will resolve your concern within 24 hours.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">No, not at all. There are no commissions involved. All you pay is a nominal convenience fee based on your chosen plan. Once you've hired, pay the salary directly to the worker.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">When you try HNM, there's always an assurance of a happy experience. <br><br>
    
    You may consider your payment as a deposit. <br><br>
    
    You either get to find a worker through HNM, or the platform gives you a 100% refund without any questions. The only non-refundable part is the Platform fee and the Assistance fee (If you opt for the Premium Plan or opt for Assistance separately). Please remember to claim your refund within 15 days of your order. <br><br>
    
    To know more, read through our Refund Policy https://helpersnearme.com/refund-policy-details</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">No, we do not have any replacement policy. <br><br>
    
    We charge a small fee in the process, which does not give us enough bandwidth to accommodate a replacement after a few months. <br><br>
    
    However, as long as your order is active (about 15 days from the date of order), you always have the option to return to the other workers who may feature in your search results. Alternatively, you can opt for the Replacement Cover or contact customer care for assistance.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">It doesn't take long. Once you've sent us a formal confirmation for a refund, it gets processed within the same week, and you get the credit back to the source within 7-10 working days.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">No, we don't. For Workers, the service is FREE. HNM helps workers find local employment absolutely free of cost.</p>
              </div>
              </section>
                      <section class="faq" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <h3 class="faq-qus" itemprop="name">
              ...
              <div class="faq-ans" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Helpers Near Me (HNM) is a few years old DIPP recognised startup. HNM is not an NGO. It is a for-profit social enterprise.<br><br>
    
    HNM uses technology and a lot of groundwork to help you connect directly with workers without any middlemen or commissions.<br><br>
    
    On one end, HNM helps the underprivileged workers of India find local employment, free of cost, directly from nearby employers like yourself. On the other, the digital infrastructure built around HNM makes it easy, quick, reliable & affordable for anyone to find & hire 100+ profiles of nearby workers.</p>
              </div>
              </section>
                    </amp-accordion>
          </div>
