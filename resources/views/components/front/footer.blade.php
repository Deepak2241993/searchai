		...
		<nav style="width:100%" class="ampstart-footer-nav">
			<div class="sm-col-12 md-col-4 md-col lg-col lg-col-4">
				...
				<ul class="list-reset footer-links mb2">
					...
					<li><a rel="noopener" href="#" target="_blank" class="inline-block footer-link text-decoration-none" style="line-height:24px">E-44/3, Pocket D, Okhla Phase II, Okhla Industrial Estate, New Delhi, Delhi 110020</a></li>
			...
			<div class="sm-col-12 md-col-2 md-col lg-col lg-col-2 text-center">
				<amp-img layout="fixed" width="150" height="50" src="{{url('/front-assets')}}/images/footer_logo.png" alt="Helpers near me"></amp-img>
			</div>
		</nav>
	  </div>	
	</div>
