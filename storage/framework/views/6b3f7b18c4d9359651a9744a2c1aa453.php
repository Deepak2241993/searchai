...
<main id="content">
    <section id="slider">
        <div class="owl-carousel owl-theme">
            <?php $__currentLoopData = $bannerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="slider-item"
                style="background-image: url('<?php echo e(url('/') . '/' . ('storage/' . $banner->image)); ?>')">
                <div class="slider-content m-auto text-center">
                    <h1 class="text-shadow light"><?php echo e($banner->title); ?></h1>
                    <h4 class="text-shadow light" style="max-width:780px"><?php echo e($banner->description); ?></h4>
                </div>
            </div>
    ...
    <div class="button-container">
        ...
        <a href="<?php echo e(route('services.show', $item->service_slug)); ?>">
            <button class="btn-submit"><?php echo e($item->name); ?></button>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
        ...
        <div class="container">
            ...
            <div class="layout-wrap layout-row layout-align-center-center text-center">
                <a class="text-decoration-none" href="find-helpersd22b.html?group=1">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/house.svg" width="60"
                ...
                <a class="text-decoration-none" href="find-helperse026.html?group=2">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/chair.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers5848.html?group=15">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/luggage.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers106a.html?group=8">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/car.svg" width="60" height="60"
                                alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers2f2b.html?group=4">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/hospital.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers4b69.html?group=3">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/shop.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers1c34.html?group=7">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/food.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers9244.html?group=6">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/barbershop1.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers7383.html?group=16">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/school.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers61b9.html?group=5">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/factory2.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helperscdac.html?group=18">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/workers.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
                ...
                <a class="text-decoration-none" href="find-helpers921f.html?group=19">
                    <div style="width:100px;margin:5px" class="card box-hover-effect">
                        <div style="background:#ccc;padding:10px;border-radius:10px 10px 0 0;">
                            <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/car2.svg" width="60"
                                height="60" alt="Steps"></amp-img>
                        </div>
                        <div class="card-body" style="padding:10px">
                            <!--<div style="margin:10px 0" class="divider"></div>-->
            ...
            <div class="text-center my2">
                <amp-carousel height="190" layout="fixed-height" type="carousel">
                    <a style="text-decoration:none;padding:2px" href="find-helpers.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/destination.svg" width="75"
                    ...
                    <a style="text-decoration:none;padding:2px" href="verifications.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/shield2.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
                    ...
                    <a style="text-decoration:none;padding:2px" href="salary-tracker.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/trending.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
                    ...
                    <a style="text-decoration:none;padding:2px" href="https://worker.helpersnearme.com/">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/join_us.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
                    ...
                    <a style="text-decoration:none;padding:2px" href="my-orders.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/your_orders.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
                    ...
                    <a style="text-decoration:none;padding:2px" href="customer-reviews.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/customer-review.svg"
                    ...
                    <a style="text-decoration:none;padding:2px" href="refer-your-friends.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/chat.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
                    ...
                    <a style="text-decoration:none;padding:2px" href="refer-a-worker.html">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/referral.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
                    ...
                    <a style="text-decoration:none;padding:2px" href="mailto:">
                        <div style="min-width:125px" class="card box-hover-effect">
                            <div style="background:#ccc;padding:10px 6px;border-radius:10px 10px 0 0;">
                                <amp-img src="<?php echo e(url('/front-assets')); ?>/images/icons/contact-us.svg" width="75"
                                    height="75" alt="Steps"></amp-img>
                            </div>
                            <div style="padding:8px" class="card-body">
                                <!--<div style="margin:10px 0" class="divider"></div>-->
