                        ...
                        <div class="billing-details">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="alternateaddress" name="alternateaddress" class="form-control"
                                    value="<?php echo e(isset($customerAddress) ? $customerAddress->alternate_address : ''); ?>"
                            ...
                            <div class="card shadow-lg border-light">
                                <div class="card-body">
                                    ...
                                    <div class="cart-items-list mb-4">
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-3">
                                                <div>
                                                    <h5 class="font-weight-bold"><?php echo e($item['serviceName']); ?></h5>
                                                    <input type="hidden" id="serviceName" name="serviceName" value="<?php echo e($item['serviceName']); ?>">
                                                    <span class="text-muted">Rs.<?php echo e($item['pricePerItem']); ?> x <?php echo e($item['tokens']); ?> tokens</span>
                                                </div>
                                                <div class="text-right">
                                                <!-- <span class="text-muted">Rs.<?php echo e($item['pricePerItem']); ?> x <?php echo e($item['tokens']); ?> tokens</span> -->
                                                    <!-- <strong>Amount: Rs.<?php echo e($item['pricePerItem'] * $item['tokens']); ?></strong> -->
                                                </div>
                                                <button type="button" class="btn btn-sm btn-danger mt-2" data-item-id="<?php echo e($item['id']); ?>">
                                    ...
                                    <div class="d-flex justify-content-between mb-4">
                                        ...
                                        <span class="text-right">Rs.<?php echo e($amount); ?></span>
                                    </div>
                                    ...
                                    <div class="payment-information mb-4">
                                        <div class="form-check mb-3">
                                            ...
                                            <input type="hidden" id="order-amount" name="amount" value="<?php echo e($amount); ?>">
