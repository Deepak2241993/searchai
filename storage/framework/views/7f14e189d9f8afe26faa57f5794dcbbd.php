<footer id="footer">
		...
		<nav style="width:100%" class="ampstart-footer-nav">
			<div class="sm-col-12 md-col-4 md-col lg-col lg-col-4">
				...
				<div class="md-hide lg-hide">
						  ...
						  <div class="card-body">
							<div class="md-list">
							  <div class="md-list-item">
								...
								<amp-img layout="fixed" width="28" height="28" src="<?php echo e(url('/front-assets')); ?>/images/icons/phone-call.png" alt="Call us"></amp-img>
							  </div>
							</div>
						  </div>
						</div>
						  ...
						  <div class="card-body">
							<div class="md-list">
							  <div class="md-list-item">
								...
								<amp-img layout="fixed" width="28" height="28" src="<?php echo e(url('/front-assets')); ?>/images/icons/whatsapp-line.svg" alt="WhatsApp us"></amp-img>
							  </div>
							</div>
						  </div>
						</div>
					...
					<div class="mb1">
					  <a class="text-decoration-none" href="mailto:contact@helpersnearme.com" style="color:#000;display:block">
						<div class="card" style="background:#6c9aa5">
						  <div class="card-body">
							<div class="md-list">
							  <div class="md-list-item">
								<p style="font-size:15px">Or Write to us</p>
								<amp-img layout="fixed" width="28" height="28" src="<?php echo e(url('/front-assets')); ?>/images/icons/message.svg" alt="Email us"></amp-img>
							  </div>
							</div>
						  </div>
						</div>
					...
					<div class="mb1">  
					  <a class="text-decoration-none" href="tel:+919599705371" style="color:#000;display:block">
						<div class="card" style="background:#6c9aa5">
						  <div class="card-body">
							<div class="md-list">
							  <div class="md-list-item">
								<p style="font-size:15px;line-height:23px">काम ढूंढ रहें हैं? हमसे जुड़ने के लिये कॉल करें</p>
								<amp-img layout="fixed" width="28" height="28" src="<?php echo e(url('/front-assets')); ?>/images/icons/phone-call.png" alt="Call us" style="display:table"></amp-img>
							  </div>
							</div>
						  </div>
						</div>
					...
					<div>  
					  <a class="text-decoration-none" rel="noreferrer" target="_blank" href="https://api.whatsapp.com/send?phone=919599705371&amp;text=+%E0%A4%AE%E0%A5%81%E0%A4%9D%E0%A5%87+%E0%A4%95%E0%A4%BE%E0%A4%AE+%E0%A4%95%E0%A5%80+%E0%A4%9C%E0%A4%B0%E0%A5%81%E0%A4%B0%E0%A4%A4+%E0%A4%B9%E0%A5%88+%E0%A5%A4" style="color:#000;display:block">
						<div class="card" style="background:#6c9aa5">
						  <div class="card-body">
							<div class="md-list">
							  <div class="md-list-item">
								<p style="font-size:15px;line-height:23px">या हमसे जुड़ने के लिये WhatsApp करें</p>
								<amp-img layout="fixed" width="28" height="28" src="<?php echo e(url('/front-assets')); ?>/images/icons/whatsapp-line.svg" alt="Call us" style="display:table"></amp-img>
							  </div>
							</div>
						  </div>
						</div>
			...
			<div class="sm-col-12 md-col-2 md-col lg-col lg-col-2 text-center">
				<amp-img layout="fixed" width="175" height="175" src="<?php echo e(url('/front-assets')); ?>/images/footer_logo.png" alt="Helpers near me"></amp-img>
			</div>
		</nav>
	  </div>	
	</div>
	<div style="background:#2e2d2d;color:#fff;padding:15px 15px 100px;" class="copyright">
        ...
        <li class="social-list-item">
          <a class="social-link" rel="noopener" href="#" target="_blank" aria-label="Helper Near Me on Facebook" style="background:#3b5998"><amp-img layout="fixed" width="40" height="40" src="<?php echo e(url('/front-assets')); ?>/images/icons/facebook.svg" alt="Helper Near Me on Facebook"></amp-img></a>
        </li>
        <li class="social-list-item">
        ...
        <li class="social-list-item">
          <a class="social-link" rel="noopener" href="#" target="_blank" aria-label="Helper Near Me on Youtube" style="background:#bb0000"><amp-img layout="fixed" width="40" height="40" src="<?php echo e(url('/front-assets')); ?>/images/icons/youtube.svg" alt="Helper Near Me on Youtube"></amp-img></a>
        </li> 
        <li class="social-list-item">
          <a class="social-link" rel="noopener" href="#" target="_blank" aria-label="Helper Near Me on WhatsApp" style="background:#55EB4C"><amp-img layout="fixed" width="40" height="40" src="<?php echo e(url('/front-assets')); ?>/images/icons/whatsapp.svg" alt="WhatsApp Us"></amp-img></a>
        </li>
		  </ul>
		</nav>
		<h5 class="text-center">Copyright &copy; 2016-24 INeedAHelp Technologies Pvt. Ltd. | All rights reserved</h5>
	</div>
</footer><?php /**PATH C:\xampp\htdocs\newsearchai\resources\views/components/front/footer.blade.php ENDPATH**/ ?>